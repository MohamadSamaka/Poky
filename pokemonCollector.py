...
class PokemonCollector:
    ...
    def get_pokemon(self, name):
        ...
        """
        if name in self.existing_pokemon_data:
            Pokemon_data =  self.existing_pokemon_data[name]
    ...
    def create_pokemon(self, name):
        ...
        speceies_data = requests.get(species_url).json()
        species = speceies_data['genera'][7]['genus']

        descriptions = speceies_data['flavor_text_entries']
